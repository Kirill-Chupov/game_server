...
![demo.gif](https://github.com/Kirill-Chupov/game_server/blob/main/demo/demo.gif)
## Описание проекта:
...
#### Скриншот с карты Town:
![demo.png](https://github.com/Kirill-Chupov/game_server/blob/main/demo/demo.png)
